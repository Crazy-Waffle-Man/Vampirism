...
public class UnderworldDensityFunction implements DensityFunction.SimpleFunction {
    public static final KeyDispatchDataCodec<UnderworldDensityFunction> CODEC = KeyDispatchDataCodec.of(
            MapCodec.unit(new UnderworldDensityFunction(0))
    );

    private final SimplexNoise islandNoise;

    public UnderworldDensityFunction(long seed) {
